				...
				<div className='bg-white p-4 rounded-xl flex'>
					...
					<div className='post-container px-4 grow'>
						<div className='flex items-center justify-between mb-2'>
							...
							<div className='rounded-full px-3 py-0.5 bg-gray-200 cursor-pointer relative' onClick={() => setEditModal((prev) => !prev)}>
						...
						<div className='flex gap-3 my-4'>
							...
							<div className='bg-slate-200 rounded-2xl py-2 px-3'>
								...
								<p className='text-sm text-gray-500'>
									...
									architecto fugit nulla dolor maxime doloribus saepe.
								</p>
							</div>
						</div>
					</div>
