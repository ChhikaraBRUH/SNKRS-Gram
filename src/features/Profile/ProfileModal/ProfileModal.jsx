		...
		<div className={`modal-container justify-center items-center hidden`}>
			<div className='modal-container-main flex flex-col gap-4 p-4 rounded-xl w-1/5 md:w-4/5'>
				...
				<div className='flex flex-col gap-4'>
					<div className='flex'>
						...
						<div className='relative'>
							<img
								src='https://pbs.twimg.com/profile_images/1494970975942688770/mVmFT4P__400x400.jpg'
				...
				<div className='px-1 py-1 text-right'>
					<button className='px-4 py-1 rounded-lg bg-violet-600 text-white font-medium hover:bg-violet-500'>UPDATE</button>
				</div>
			</div>
		</div>
	);
